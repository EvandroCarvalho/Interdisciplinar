...
export default class ProductsSale extends Component {
    ...
    saveItem = async ({ tableColumns, itemId, customer, employee, itemName }) => {
        ...
        tableColumns = { ...tableColumns, itemId, customer, employee, itemName, invoice }
        if (tableColumns.id) {
    ...
    finishOrder = async (data) => {
        ...
        if (response.status === 201) {
            this.setState({ data: [], itemId: '', itemName: '', total: 0, showModal: true })
        }
    }
            ...
            <Fragment>
                <div>
                    ...
                    <div className="col-md-4">
                        <Button
                            onClick={() => this.saveItem(this.state)}
                        >
                            Adicionar Item
                        </Button>
                    </div>
